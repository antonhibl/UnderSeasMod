...
public class RegisterItems {
    ...
    public static void register() {
        Registry.register(Registry.ITEM, new Identifier("underseas", "prisma_ingot"), PRISMA_INGOT);
        Registry.register(Registry.ITEM, new Identifier("underseas", "prisma_helmet"), PRISMA_HELMET);
        Registry.register(Registry.ITEM, new Identifier("underseas", "prisma_chestplate"), PRISMA_CHESTPLATE);
        Registry.register(Registry.ITEM, new Identifier("underseas", "prisma_leggings"), PRISMA_LEGGINGS);
        Registry.register(Registry.ITEM, new Identifier("underseas", "prisma_boots"), PRISMA_BOOTS);
    }
}
